(function() {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function() {
        ...
        return h(d, c), d.prototype.gridDefaults = {
            ...
            this.raphael.clear(), [object Object]0) : (o = this.cumulative ? 0 : null, p = this.cumulative ? 0 : null, 
        ...
        function c(a) {
            ...
            this instanceof b.Line ? [object Object]0 : new b.Line(a);
        }
    ...
    b.Area = function(c) {
        function d(c) {
            ...
            "auto" === f.fillOpacity && (f.fillOpacity = f.behaveLikeLine ? .8 : 1), [object Object]0) : new b.Area(c);
        }
        var e;
        return h(d, c), e = {
            fillOpacity: "auto",
        ...
        function d(c) {
            ...
            this.onGridClick = f(this.onGridClick, this), this instanceof b.Bar ? [object Object]0 : new b.Bar(c);
        }
